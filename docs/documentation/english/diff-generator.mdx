...
[Diff Generator](https://github.com/sandraLbdvTW/diff-generator) is a command-line application that allows users to find the differences between two configuration files. This tool supports multiple file formats and output styles out of the box.
...
- Installed [Node.js](https://nodejs.org/en) version 8.0 or higher
:::
...
### Usage
To use Diff Generator, execute the script from the project root directory.
...
These examples use the sample Diff Generator files. Find these files in `./__fixtures__/`, if you want to edit them or replace them with your own.
